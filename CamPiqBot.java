...
/**
 * CamPiqBot - a robot by Luis Cambero Piqueras
 */
public class CamPiqBot extends AdvancedRobot
{
	...
	private void initialize(){
		...
		triggerCloseWall = new Condition("triggerclosewall") {
      		 public boolean test() {
			 	//System.out.println("Close wall: " + closeWall());
		        return closeWall();
		     }
	   };
	...
	private void updateLocation(){
		...
		//System.out.println("XS2: " + xs2 + ", YS2: " + ys2);
		//System.out.println("Heading: " + bodyHeading);
	...
	private double map(double inputValue, double startInputRange, double endInputRange, double startOutputRange, double endOutputRange){
		...
		//System.out.println("startInputRange: " + startInputRange + ", endInputRange: " + endInputRange);
		//System.out.println("startOutputRange: " + startOutputRange + ", endOutputRange: " + endOutputRange);
	...
	public void onCustomEvent(CustomEvent e) {
		if (e.getCondition().getName().equals("triggerclosewall")) {
			// What to do when you are near a wall
          	//System.out.println("Avoid close wall");
			this.updateLocation();
	...
	/**
	 * onRobotDeath: What to do when an pther robot dies
	 */
